...
async function main() {
    try {
        ...
        const secret = await ca.register({ affiliation: 'alpha.department1', enrollmentID: userName, role: 'clientMaster', attrs: [
            { name: 'isTeacher', value: 'true', ecert: true},
            { name: 'email', value: userName+'@gmail.com', ecert: true},
        ] }, adminIdentity);
